...
# 히든레이어의 뉴런수에 따라 학습 속도의 차이가 엄청나다
# 일례로 뉴런수가 500개일때 에피소드 104번만에 87412의 보상을 달성했으며
# 실제 플레이 영상을 보면 뉴런이 10개 일때와 비교하여 매우 민감하게 반응 했다.
# 아무래도 뉴런의 수에 따라 정밀도가 높아지는 효과를 얻는거 같다.